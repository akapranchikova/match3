...
const archetypeDescriptions: Record<string, string> = {
    ...
    Воин: 'Вы — человек действия, чья сила и целеустремленность ведут к победам, но иногда граничат c излишней напористостью. Сила духа и железная воля помогают вам преодолевать препятствия и вдохновлять других.',
    ...
    Творец: 'Вы — генератор идей и воплощённой гармонии. Через принятие себя вы открыли в себе источник изобилия, и теперь c лёгкостью и радостью транслируете свой уникальный взгляд на мир.',
    ...
    Маг: 'Вы — визионер. Вы не просто следуете трендам — вы создаёте их, очаровывая аудиторию ясностью мысли и силой убеждения. Реальность начинается c идеи, а вы — её главный творец.',
    ...
    Шут: 'Вы — мудрый наблюдатель, для которого жизнь — увлекательная игра. Вы видите мир без иллюзий, но c любопытством и добрым юмором. Легко пробуете новое и вдохновляете других своей свободой быть собой.'
};
const archetypeName: Record<string, string> = {
    Дитя: 'Нико Пиросмани',
    'Славный малый': 'Ольга Розанова',
    Воин: 'Александр Древин',
    Опекун: 'Ольга Розанова',
    Искатель: 'Михаил Матюшин',
    Бунтарь: 'Илья Машков',
    Эстет: 'Владимир Баранов-Россине',
    Творец: 'Аристарх Лентулов',
    Правитель: 'Казимир Малевич',
    Маг: 'Георгий Якулов',
    Мудрец: 'Василий Кандинский',
    Шут: 'Михаил Ларионов'
};
...
const baseCards: ArchetypeCard[] = [
    ...
    },
    {
        id: 4,
        title: 'Опекун 100%',
        description: 'Вам важно, чтобы рядом было спокойно, надёжно и c заботой о людях.',
