...
export const renderNextPoint = (): HTMLElement => {
  ...
  card.innerHTML = `
    ...
    <div class="point-layout__actions point-layout__actions--inline">
      <button class="button icon-button primary" data-action="map" aria-label="Открыть карту этажа">
    ...
    <button class="button primary point-layout__route" data-action="route">Открыть весь маршрут</button>
  `
